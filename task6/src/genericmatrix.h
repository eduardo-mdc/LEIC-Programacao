...
#ifndef TASK6_GENERICMATRIX_H
#define TASK6_GENERICMATRIX_H
...
namespace generic {
    ...
    private:
        ...
        int lines,cols;
    public:
        genericmatrix(int lines, int cols, const T& initial_value);
        ~genericmatrix();
        int getLines() const;
        int getCols() const;
        ...
        genericmatrix& operator=(const genericmatrix<T>& m);
    };
};
